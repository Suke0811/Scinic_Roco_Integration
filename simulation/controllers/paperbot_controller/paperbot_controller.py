...
#left_motor.enableTorqueFeedback(10)

right_motor.setPosition(float('inf'))
right_motor.setVelocity(0.0)
#right_motor.enableTorqueFeedback(10)
...
while robot.step(TIME_STEP) != -1:
    ...
    # lt = left_motor.getTorqueFeedback()
    # rt = right_motor.getTorqueFeedback()
    # torque = abs(lt) + abs(rt)
    # integrated_torque += torque
    # robot.setCustomData(str(integrated_torque))
